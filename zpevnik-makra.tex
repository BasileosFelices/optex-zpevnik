...
\def\booktitle#1\par{\vbox to 0.25\vsize{}\centerh{\booktitf #1}\bigskip\nobreak}

\def\bookauthor#1\par{\centerh{\bookautf #1}}
...
\def\title#1{{\sngtitf #1}\par\bigskip\nobreak
	\immediate\write\writef{\string\tocline{#1}{\the\pageno}}
}

\def\author#1{{\sngautf #1}\par\bigskip}


%---Předehra-----------------------------------------
\def\intro#1\par{{\it Intro: } #1 \bigskip}
...
\def\refrain{{\bf Ref.}\par\bigskip}
